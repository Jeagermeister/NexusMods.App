...
using Union = OneOf.OneOf<
    Apocrypha.UI.Sdk.Icons.Empty,
    Apocrypha.UI.Sdk.Icons.ProjektankerIcon,
    Apocrypha.UI.Sdk.Icons.AvaloniaImage,
    Apocrypha.UI.Sdk.Icons.AvaloniaSvg,
    Apocrypha.UI.Sdk.Icons.AvaloniaPathIcon,
    Apocrypha.UI.Sdk.Icons.SimpleVectorIcon>;

namespace Apocrypha.UI.Sdk.Icons;
