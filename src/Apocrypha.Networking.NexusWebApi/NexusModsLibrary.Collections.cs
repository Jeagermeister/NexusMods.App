...
public partial class NexusModsLibrary
{
    ...
    private static Optional<Apocrypha.Abstractions.NexusModsLibrary.Models.CollectionStatus> ToStatus(ICollection collectionFragment)
    {
        if (collectionFragment.CollectionStatus is null) return Optional<Apocrypha.Abstractions.NexusModsLibrary.Models.CollectionStatus>.None;
