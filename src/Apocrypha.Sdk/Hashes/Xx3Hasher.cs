...
{
    public static Hash Hash(ReadOnlySpan<byte> input) => NexusMods.Hashing.xxHash3.Hash.From(XxHash3.HashToUInt64(input));
    ...
    public static Hash Finish(XxHash3 state) => NexusMods.Hashing.xxHash3.Hash.From(state.GetCurrentHashAsUInt64());
