...
namespace NexusMods.Games.BepInEx.Schema;
...
{
    private const string SchemaResourceName = "NexusMods.Games.BepInEx.Assets.ecosystem-schema.json";
    private const string NexusIdsResourceName = "NexusMods.Games.BepInEx.Assets.bepinex-nexus-ids.json";
