...
using Apocrypha.Networking.NexusWebApi.Errors;
...
using CollectionMod = Apocrypha.Abstractions.Collections.Json.Mod;
using ModSource = Apocrypha.Abstractions.Collections.Json.ModSource;
using UpdatePolicy = Apocrypha.Abstractions.Collections.Json.UpdatePolicy;
...
public static class CollectionCreator
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        var defaultImageStreamFactory = new EmbeddedResourceStreamFactory<CollectionDownloader>("Apocrypha.Collections.default-collection-image.webp");
