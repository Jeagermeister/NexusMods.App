            ...
            .ConfigureProperty(
                ...
                new PropertyOptions<DataModelSettings, ConfigurablePath[]>
                {
                    ...
                    DescriptionFactory = currentPath => $"""
                          ...
                          *Important: Existing files won’t move automatically when you change storage location, you’ll need to move them manually.* [Need help?](https://nexus-mods.github.io/Apocrypha.App/users/faq/MoveLibraryLocation/)
                          """,
