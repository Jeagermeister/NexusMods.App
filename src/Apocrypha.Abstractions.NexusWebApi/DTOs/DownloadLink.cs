...
using Apocrypha.Abstractions.NexusWebApi.DTOs.Interfaces;
using CDNName = Apocrypha.Abstractions.NexusWebApi.Types.CDNName;

// ReSharper disable UnusedAutoPropertyAccessor.Global
namespace Apocrypha.Abstractions.NexusWebApi.DTOs;
