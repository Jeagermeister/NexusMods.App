...
public class SkyrimSE : ICreationEngineGame, IGameData<SkyrimSE>
{
    ...
    public IStreamFactory IconImage { get; } = new EmbeddedResourceStreamFactory<SkyrimSE>("Apocrypha.Games.CreationEngine.Resources.SkyrimSE.thumbnail.webp");
    public IStreamFactory TileImage { get; } = new EmbeddedResourceStreamFactory<SkyrimSE>("Apocrypha.Games.CreationEngine.Resources.SkyrimSE.tile.webp");
