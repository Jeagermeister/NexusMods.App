...
using GroupId = Apocrypha.Abstractions.GuidedInstallers.ValueObjects.GroupId;
using Option = Apocrypha.Abstractions.GuidedInstallers.Option;
using OptionGroup = Apocrypha.Abstractions.GuidedInstallers.OptionGroup;
using OptionGroupType = Apocrypha.Abstractions.GuidedInstallers.OptionGroupType;
using OptionType = Apocrypha.Abstractions.GuidedInstallers.OptionType;
