...
using Apocrypha.Games.Larian.BaldursGate3.Installers;
...
public class BaldursGate3 : IGame, IGameData<BaldursGate3>
{
    ...
    public IStreamFactory IconImage { get; } = new EmbeddedResourceStreamFactory<BaldursGate3>("Apocrypha.Games.Larian.Resources.BaldursGate3.thumbnail.webp");
    public IStreamFactory TileImage { get; } = new EmbeddedResourceStreamFactory<BaldursGate3>("Apocrypha.Games.Larian.Resources.BaldursGate3.tile.webp");
