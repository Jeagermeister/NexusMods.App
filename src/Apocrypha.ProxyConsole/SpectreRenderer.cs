...
using Apocrypha.ProxyConsole.Messages;
...
namespace Apocrypha.ProxyConsole;
...
public class SpectreRenderer : IRenderer
{
    ...
    private async ValueTask<SpectreRender.IRenderable> ToSpectreAsync(IRenderable renderable)
    {
        switch (renderable)
        {
            case Apocrypha.Sdk.ProxyConsole.Text text:
            ...
            case Apocrypha.Sdk.ProxyConsole.Table table:
    ...
    private async ValueTask<SpectreRender.IRenderable> ToSpectreAsync(Apocrypha.Sdk.ProxyConsole.Table table)
    {
