using Apocrypha.Abstractions.EpicGameStore.Attributes;
using NexusMods.MnemonicDB.Abstractions.Attributes;
using NexusMods.MnemonicDB.Abstractions.Models;
using BuildIdAttribute = Apocrypha.Abstractions.EpicGameStore.Attributes.BuildIdAttribute;

namespace Apocrypha.Abstractions.Games.FileHashes.Models;
