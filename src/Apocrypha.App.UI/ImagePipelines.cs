...
public static class ImagePipelines
{
    ...
    private static readonly Bitmap CollectionTileFallback = new(AssetLoader.Open(new Uri("avares://Apocrypha.App.UI/Assets/collection-tile-fallback.png")));
    private static readonly Bitmap CollectionBackgroundFallback = new(AssetLoader.Open(new Uri("avares://Apocrypha.App.UI/Assets/collection-background-fallback.png")));
    private static readonly Bitmap UserAvatarFallback = new(AssetLoader.Open(new Uri("avares://Apocrypha.App.UI/Assets/DesignTime/avatar.webp")));
    internal static readonly Bitmap ModPageThumbnailFallback = new(AssetLoader.Open(new Uri("avares://Apocrypha.App.UI/Assets/mod-thumbnail-fallback.png")));
    internal static readonly Bitmap MarkdownFallback = new(AssetLoader.Open(new Uri("avares://Apocrypha.App.UI/Assets/transparent.png")));
