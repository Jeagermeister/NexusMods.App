...
namespace Apocrypha.App.UI.Pages.LibraryPage.Collections;
...
public class CollectionCardDesignViewModel : AViewModel<ICollectionCardViewModel>, ICollectionCardViewModel
{
    ...
    public Bitmap Image => new(AssetLoader.Open(new Uri("avares://Apocrypha.App.UI/Assets/DesignTime/collection_tile_image.png")));
