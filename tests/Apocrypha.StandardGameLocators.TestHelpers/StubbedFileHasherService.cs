...
public class StubbedFileHasherService : IFileHashesService
{
    ...
    {
        var backend = new NexusMods.MnemonicDB.Storage.RocksDbBackend.Backend();
        ...
        var overlayBackend = new NexusMods.MnemonicDB.Storage.RocksDbBackend.Backend();
    ...
    public Task AddLocalSteamVersionAsync(
        Apocrypha.Abstractions.Steam.Values.AppId appId,
        Apocrypha.Abstractions.Steam.Values.DepotId depotId,
        Apocrypha.Abstractions.Steam.Values.ManifestId manifestId,
        string versionName,
        NexusModsGameId? gameId,
        Apocrypha.Abstractions.Games.FileHashes.Values.OperatingSystem operatingSystem,
